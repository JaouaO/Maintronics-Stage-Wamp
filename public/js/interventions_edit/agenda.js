...
export function alreadyHasAnyForThisDossier() {
    return _hasAnyFn();
}
export function alreadyHasValidatedForThisDossier() {
    return _hasValidatedFn();
}
...
export function initAgenda() {
    ...
    // ---- injecte les closures dans l'API exportée + fallbacks window.* ----
    const computeHasAny = () => {
...
`;
    ...
    function showEventModal(ev) {
        ...
        // Actions seulement si RDV temporaire du dossier courant
        if (isTemp && sameThis) {
            parts.push(`
